...
function Login() {
    ...
    return (
        <div className="min-h-screen bg-gray-100 dark:bg-gray-900 flex items-center justify-center p-4">
            <div className="w-full max-w-md bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl overflow-hidden">
                <form onSubmit={handleSubmit(onSubmit)} className="p-6 flex flex-col justify-center">
                    ...
                    <FormInput
                        ...
                        type="password"
                        icon={<LuLockKeyhole className="absolute left-3 top-3 text-gray-700 dark:text-gray-400" size={15} />}
                        register={register}
                    ...
                    <Button variant="primary" type="submit" className="s">
                        <LuLogIn size={16} />
                        {/* Login */}
                    </Button>
                </form>
