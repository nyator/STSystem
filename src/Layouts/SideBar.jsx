            ...
            <div
                ...
                <div className={`flex items-center ${isOpen ? 'justify-between' : 'justify-center'} px-2 py-5 border-b mx-2 border-gray-200 dark:border-gray-700`}>
                    ...
                    <button
                        ...
                        className="p-2 hover:bg-gray-200 dark:hover:bg-gray-700 bg-gray-50 dark:bg-gray-800 rounded-lg border-2 border-gray-100 dark:border-gray-700"
                    >
                ...
                <nav className={`flex ${isOpen ? 'items-start' : 'items-center'} flex-col justify-start flex-1 py-4 px-2 space-y-3`}>
                    {menuItems.map((item) => (
                        <a
                            ...
                            className={`flex space-x-2 p-2 items-start rounded-lg border-2 ${isOpen ? 'justify-start' : 'justify-center'} ${activeMenu === item.label ? 'bg-blue-500 border-blue-500 text-white' : ' bg-gray-50 dark:bg-gray-800 border-gray-100 dark:border-gray-700'} ${activeMenu === item.label ? 'hover:bg-blue-600' : 'hover:bg-gray-200 dark:hover:bg-gray-700'} transition-all duration-300 ${isOpen ? 'w-full' : ''}`}
                        >
                            <item.icon size={15} />
                ...
                <nav className={`flex ${isOpen ? 'items-start' : 'items-center'} flex-col justify-end flex-1 py-4 px-2 space-y-3`}>
                    <a
                        ...
                        className={`flex space-x-2 p-2 items-start rounded-lg border-2 ${isOpen ? 'justify-start' : 'justify-center'} ${activeMenu === 'Settings' ? 'bg-black dark:bg-gray-700 border-gray-600 dark:border-gray-500 text-white' : '  border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-800'} ${activeMenu === "Settings" ? 'hover:bg-mblack dark:hover:bg-gray-600' : 'hover:bg-gray-200 dark:hover:bg-gray-700'} transition-all duration-300 ${isOpen ? 'w-full' : ''}`}
                    >
                        <LuSettings size={15} />
                    ...
                    {/* <div className='flex space-x-2 items-center mx-2'>
                        {isOpen ? <span className="text-xs font-medium text-nowrap">UI Theme</span> : null}
