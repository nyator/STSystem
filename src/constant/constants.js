...
export const baseClasses = "group border-1 gap-1 text-nowrap p-2 rounded-lg font-medium text-xs transition-all ease-in-out duration-300 flex items-center justify-between active:scale-[0.98]";
