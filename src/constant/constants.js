...
export const optionBaseClasses = "bg-white dark:bg-gray-800 px-3 py-2 text-gray-800 dark:text-gray-100 font-medium rounded-xl border border-gray-200 dark:border-gray-700 items-center flex justify-center text-sm sm:text-xs transition-all ease-in-out duration-200 active:scale-[0.98] h-9";
export const baseClasses = "group border gap-1.5 text-nowrap px-3 py-2 h-9 rounded-xl font-medium text-sm sm:text-xs transition-all ease-in-out duration-200 flex items-center justify-center active:scale-[0.98]";
