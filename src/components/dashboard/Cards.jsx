...
const Cards = () => {
    ...
    const ticketCards = [
        ...
        { id: 2, label: "Progress Tickets", value: tickets.filter(t => (t.status || '').toLowerCase() === 'in-progress').length, colors: "bg-yellow-50 text-yellow-500" },
    ...
    return (
        <div className='flex flex-wrap items-center gap-4  w-full border-b-2 border-gray-100 pb-4 mb-4 [&::-webkit-scrollbar]:h-1 [&::-webkit-scrollbar-thumb]:bg-gray-400 [&::-webkit-scrollbar-thumb]:rounded-sm'>
