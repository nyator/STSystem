...
const OptionsPopover = ({ ticket, onDelete, onAssign, onStartWork, onMarkResolved, onCloseTicket, onReopenTicket, onAddComment, rowIndex, dataLength }) => {
    const [open, setOpen] = useState(false)
    const ref = useRef(null)

    const canAssign = ticket?.status === 'open' && !ticket?.assignedTo
    const canStartWork = (ticket?.status === 'assigned' || ticket?.status === 'reopened')
    const canMarkResolved = ticket?.status === 'in-progress'
    ...
    const canAddComment = ticket?.status !== 'closed'
                    ...
                    return (
                        <div onMouseDown={(e) => e.stopPropagation()}
                            ...
                            <button
                                ...
                                title={!canDelete ? 'Closed tickets cannot be deleted' : undefined}
                            >
