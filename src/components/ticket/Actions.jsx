        ...
        onClick={(e) => {
          ...
          if (rect) {
            setPosition({
              left: rect.right - 139,
              top:
                rowIndex >= dataLength - 4 ? rect.bottom - 75 : rect.bottom + 8,
            });
          }
          setOpen((prev) => !prev);
        }}
      ...
      {open &&
        createPortalBody(
          <div
            ...
            className="fixed z-50 flex flex-col left-10 top-full min-w-32 p-3 rounded-sm border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 overflow-hidden"
