            ...
            {isOpen && (
                ...
                >
                    <div
                        ...
                        className='bg-white p-2 px-6 rounded-2xl shadow-lg w-96 max-h-[90vh] overflow-y-auto relative z-50'
                    >
                        <button
                            onClick={onClose}
                        ...
                        <div className='flex justify-center items-center mb-4 p-2 '>
                            <h2 className='flex flex-row items-center text-3xl text-center font-semibold'>{title} {" "}
                                {TitleIcon}
