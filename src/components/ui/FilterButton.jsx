    ...
    return (
        <div className="relative">
            <button
                ...
                className={`flex items-center gap-1 text-xs text-gray-600 bg-gray-50 border-2 h-10 px-2 rounded-lg hover:bg-gray-200 transition-all ease-in-out duration-300 focus:outline-none border-gray-100`}
            >
                {hasActiveFilters && (
